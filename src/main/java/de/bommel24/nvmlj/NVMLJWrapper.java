...
interface NVMLJWrapper extends Library {
    ...
    NVMLJWrapper INSTANCE = Native.load(NVMLPath.getPath(), NVMLJWrapper.class);
    ...
    int nvmlDeviceGetSamples(long device, int type, long lastSeenTimeStamp, IntByReference sampleValType, IntByReference sampleCount, NVMLSample samples);
